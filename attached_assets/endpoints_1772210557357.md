...
**Get Aircraft Model Operation Costs**

**Request body** (`AcModelSearchOptions`):
- `modelid` (integer) -- Model ID
- `airframetype` (eAirFrameTypes)
- `maketype` (eMakeTypes)
- `make` (string)
- `annualhours` (integer) -- Annual Hours * to allow customer value for Op Costs
- `fuelprice` (number) -- Fuel Price * to allow customer value for Op Costs
- `modlist` (array)

---

### `POST` /api/Model/getModelPerformanceSpecs/{securityToken}
**Get Aircraft Model Performance Specs**
...
**Get Model Market Trend data**

**Request body** (`AcModelTrendOptions`):
- `airframetype` (eAirFrameTypes)
- `maketype` (eMakeTypes)
- `productcode` (array)
- `modelid` (integer)
...
### `POST` /api/Model/getModelIntelligence/{securityToken}
**Get Model Intelligence data**

**Request body** (`AcModelIntelOptions`):
- `airframetype` (eAirFrameTypes)
- `maketype` (eMakeTypes)
- `make` (array) -- Make name
- `model` (array) -- Model name
- `yearmfr` (string)
- `yeardlv` (string)
- `weightclass` (array)
- `categorysize` (array)
- `amod_fuselage_length` (integer)
- `fuselage_height` (integer)
- `fuselage_wing_span` (integer)
- `fuselage_width` (integer)
- `cabinsize_height` (number)
- `cabinsize_width` (number)
- `cabinsize_length` (number)
- `cabin_volume` (number)
- `baggage_volume` (number)
- `pax` (integer)
- `max_range` (integer)
